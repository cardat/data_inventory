...
1.  Double-click to run the web2py.exe file and go to `127.0.0.1:8000/cardat_data_inventory` in your browser
2.  In the top right corner, sign up with a local username and password (this is a username and password for the inventory itself, separate to your database login, if any).
